namespace FIAP.CloudGames.FakePayment
{
    ...
    {
        public FakeTransaction(FakePaymentService fakePaymentService)
        {
        ...
        public Task<FakeTransaction> AuthorizeCardTransaction()
        {
        ...
        public Task<FakeTransaction> CaptureCardTransaction()
        {
        ...
        public Task<FakeTransaction> CancelAuthorization()
        {
            var transaction = new FakeTransaction
            {
                AuthorizationCode = "",
